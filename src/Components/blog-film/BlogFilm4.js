...
export default function BlogFilm4(props) {
  let { listFilm } = useSelector((state) => state.StateManageFilm);

  const renderFilmMore = () => {
    return listFilm.slice(13, 16).map((film, index) => {
      return (
            ...
            <div className="commentFilm__left">
              <div className="commentFilm__content">
                ...
                <div className="content__text">
                  ...
                  <p className="line__text">
                    <b>The Silence Of The Lambs</b> ( <i>Sự Im Lặng Của Bầy Cừu</i> ) là tuyệt phẩm đã chiến thắng “Big Five” tại Oscar năm 1992 với hầu hết các giải thưởng quan trọng nhất. Đồng thời cũng là phim kinh dị - trinh thám duy nhất tính đến thời điểm hiện tại được xướng tên ở hạng mục Phim Hay Nhất.
                  </p>
                  ...
                  <p className="line__text">
                  Thứ gây ám ảnh và cũng được xem là thú vị ở <i>Sự Im Lặng Của Bầy Cừu</i>  chính là khâu xây dựng tính cách nhân vật, cùng màn thể hiện đẳng cấp của dàn diễn viên.
                  </p>
                  <p className="line__text">
                  Trước khi tham gia dự án, Anthony Hopkins vẫn còn là cái tên mới lạ đối với khán giả đại chúng mê điện ảnh, ông hoạt động chủ yếu ở mảng sân khấu và là một diễn viên kịch nổi tiếng tại Anh. Năm 1980 trong bộ phim <i>The Elephant Man </i> của đạo diễn David Lynch, ông vào vai một vị bác sĩ nhân hậu, hết lòng giúp đỡ nhân vật “Người Voi” - John Merrick (John Hurt). Hơn 10 năm sau, lại một lần nữa Anthony Hopkins hóa thân thành Hannibal Lecter - cũng là bác sĩ, kẻ có kiến thức vô cùng uyên bác cùng khả năng thao túng tâm trí con người.
                  </p>
                  
                  <p className="line__text">
                    <i>“Hắn ta đánh vỡ hàm của nữ y tá để lấy được lưỡi cô ta. Mạch của hắn không lên quá 85 nhịp, kể cả lúc đang ăn lưỡi cô ấy”.</i>
                  </p>
                  <p className="line__img">
                    <img
                      src={blg41}
                  ...
                  <p className="line__text">
                  Jodie Foster đã là siêu sao sở hữu tượng vàng Oscar ở thời điểm tham gia <i>Sự Im Lặng Của Bầy Cừu</i> . Ở tuổi 14, cô bé Jodie Foster đã có vai diễn nội tâm đầy phức tạp gây tranh cãi khi vào vai gái điếm trong <i>Taxi Driver (1976).</i>  Được hợp tác với huyền thoại Robert De Niro lúc ấy nhưng Jodie không hề tỏ ra lép vế khi đứng chung khung hình với ông, tài năng của cô từ đây được chú ý nhiều hơn. Năm 1988 bộ phim <i>The Accused</i>  ra mắt và nhận được nhiều lời khen từ giới phê bình, diễn xuất kinh ngạc của Jodie Foster giúp đem về cho cô giải thưởng Nữ Chính Xuất Sắc của Viện Hàn Lâm.
                  </p>
                  <p className="line__text">
